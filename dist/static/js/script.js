...
//    }, t);
// }
// outNum(3, '.performance-item__digits.years span');
...
function _createModal(options) {
  ...
  modal.insertAdjacentHTML('afterbegin', "\n      <div class=\"modal-overlay\" data-modalclose=true>\n         <div class=\"modal-content\" style=\"width: ".concat(options.width || "75%", "\">\n            <div class=\"modal-header\">\n               <span class=\"modal-title\">\n                  ").concat(options.title || '', "\n               </span>\n               ").concat(options.closable ? "<span class=\"modal-close\" data-modalclose=true>&times;</span>" : '', "\n            </div>\n            <div class=\"modal-body\">\n               ").concat(options.content || '', "\n            </div>\n            <div class=\"modal-footer\">\n            \n            </div>\n         </div>\n      </div>\n   "));
  document.body.appendChild(modal);
  return modal;
}

var modalPlugin = function modalPlugin(options) {
  var ANIM_SPEED = 200;
  ...
  var modal = {
    ...
    close: function close() {
      ...
      document.body.style.paddingRight = ''; // const scrollY = document.body.style.top;
...
adaptiveFunction(); // === Адаптивность навигации
// === Вызов меню бургер
